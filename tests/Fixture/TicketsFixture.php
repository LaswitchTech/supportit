...
class TicketsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'resolution' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'owner' => 1,
                'created' => '2018-10-25 16:19:51',
                'modified' => '2018-10-25 16:19:51',
                'account_id' => 1,
                'state' => 1,
                'status' => 1,
                'priority' => 1,
